  ...
  return (
    <>
      <div className="content_wrapper">
        ...
        <p className="lg_para">
          I am front-end developer possessing over 7 years of experience in the design, development, and deployment of
          intricate web applications and dynamic websites.
        </p>
